...
class ReplayBuffer(BaseBuffer):
    ...
    def __init__(
        ...
        if psutil is not None:
            total_memory_usage = self.observations.nbytes + self.next_observations.nbytes + self.rewards.nbytes
    ...
    def add(
        ...
        # print(obs)
        # print("obs: {}\nobservations: {}".format(obs.shape, self.observations.shape))
